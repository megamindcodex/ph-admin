<template>
  ...
  <div class="main">
    <div class="cont">
      <div class="header">
        <span class="addNewBtn" @click="productStore.showForm()">
          New product</span
        >
      </div>
      ...
      <div class="productCont" v-if="productStore.products">
        ...
        <span class="addNewCont" @click="productStore.showForm">
          New product
        </span>
      </div>
    ...
    <div>
      <Backlay class="backlay" v-if="productStore.isFormVisible">
        <span class="closeBtn" @click="productStore.removeForm()">X</span>
        <Form />
      </Backlay>
    </div>
  </div>
